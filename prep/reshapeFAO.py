...
import faostat
from fao_explore, import weighted_average, which_years, transform_colname, which_areas


# List of FAO area codes for countries in sub-saharan africa and for regions
SSAareas = [str(i) for i in [7,53,20,233,29,35,32,37,39,45,46,107,250,72,61,178,
209,238,74,75,81,90,175,114,122,123,129,130,133,136,137,144,147,158,159,184,193,
195,196,197,201,202,277,217,226,215,251,181]]
